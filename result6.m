...
rank2(isnan(rank1))=0;
newcm=[.5 .5 .5;flipud(nclCM(143,14))];
fig13=figure(1);
set(gcf,'Position',[100 100 620 1000])
imagesc(rank1);
...
print(fig13,'D:\OneDrive - Australian National University\PhD\Project2\Model comparison\Figure\fig13','-djpeg','-r600');
